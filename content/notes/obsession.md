...
Instead, Obsession plays on the half-beats. The camera doesn't respect familiar paths, motion speeds up and down to create distortion. It's almost as if the ratios for the recipe have been altered, and the end result feels _wrong_.

This in and of itself isn't uncommon in horror. From [The History and Psychology of Spooky Music and Sound Design in Film](https://www.stringandtins.com/news/the-history-and-psychology-of-spooky-music-and-sound-design-in-film):
...
Curry Barker uses these devices to tell a story of a relationship that feels _wrong_ as a viewer. And he does so with a sense of economy: the limerence stage doesn't get more than a few seconds of montage, enmeshment is physically painful to witness, and the characters swing moods wildly, trying to match each other's _off-keyness_.
