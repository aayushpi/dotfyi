...
function renderNote(note) {
  ...
  const cover = note.cover
    ? `<a href="${url}"><img class="cover" src="${coverSrc(note.cover)}" alt="${escapeHtml(note.title)} cover" width="124" style="display:block;width:124px;max-width:124px;height:auto;border:1.5px solid ${INK};margin-bottom:18px;" /></a>`
    : '';
